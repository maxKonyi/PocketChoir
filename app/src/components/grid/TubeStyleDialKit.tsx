...
export function useTubeStyleDialKit() {
    return useDialKit('Tube Style', {
        // Shading layers
        baseDarkness: [42, 0, 100],          // How much to darken the shadow pass (%)
        bodyWidth: [0.80, 0.1, 0.95],        // Width of the main color pass (multiplier)
        highlightWidth: [0.18, 0.05, 0.5],    // Width of the specular highlight (multiplier)
        highlightOpacity: [0, 0, 1.0],      // Opacity of the specular highlight
